...
kubectl delete -f ${LAB3_DIR}/peerdelete.yaml -n trident --wait --ignore-not-found
kubectl create -f ${LAB3_DIR}/peerdelete.yaml -n trident
sleep 30
kubectl logs job.batch/peer-clusters-delete -n trident
